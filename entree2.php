...
<li><a href='entreepj2.php'>Enregistrement par jour</a></li>
...
<li><a href='moden.php'>Modification</a></ul></li>
</ul></ul></li>
</div>
<body>
<body onLoad="init();">
<script src="jquery.min.js"></script>
<h3>Enregistrement par nom</h3>
<br>
<h1>
<center>
<div class="form">
...
<br>
Mois: <select name="s" class="sel" id="s" onchange="this.form.nom.focus()">
...
Jour: <input type="number" name="jour" class="sel" onkeydown="deu(event)"  autocomplete="off" size="5" id="jour"> <span id="j"></span><br><br>
...
Présence: <select name="pre" class="sel" id="pre"  onkeydown="tr(event)" onchange="this.form.nb.focus()" >
...
NB: <input type="number" name="nb" class="sel" onkeydown="nombre(event)" value="1" id="nb" autocomplete="off" size="5">
...
for($i=0;$i<$nb;$i++){
$j=$jou++;
if($moi=='avril 2020' or $moi=='juin 2020' or $moi=='septembre 2020' or $moi=='novembre 2020'){

if($j<=30 ){
mysql_query('insert into point values("'.$null.'","'.$moi.'","'.$j.'","'.$nom.'","'.$pre.'","","","","","","","","","","")');}}

if($moi=='Janvier 2020' or $moi=='mars 2020' or $moi=='mai 2020' or $moi=='juillet 2020' or $moi=='aout 2020' or $moi=='octobre 2020' or $moi=='décembre 2020'){
if($j<=31){
mysql_query('insert into point values("'.$null.'","'.$moi.'","'.$j.'","'.$nom.'","'.$pre.'","","","","","","","","","","")');}}

if($j>30){ $one2++; mysql_query('insert into point values("'.$null.'","'.$moi.'","'.$one2.'","'.$nom.'","'.$pre.'","","","","","","","","","","")');}}

mysql_query("DELETE t1 
...
$nbb=mysql_query("SELECT* FROM point order by id DESC limit $nb");
while ($mo=mysql_fetch_array($nbb)){
$mi=$mo['jour'];$mi2=$mo['mois'];$mi3=$mo['nom'];$mi4=$mo['pre'];
if($moi=='avril 2020' or $moi=='aout 2020' or $moi=='octobre 2020' ){
echo"<center><div class='f'><font color='white'>Le mois d' <font style='color:blue'>$mi2</font> jour <font style='color:blue'>$mi</font> le nom <font style='color:blue'>$mi3</font> est <font style='color:blue'>$mi4</font></div></center>";}
else{
echo"<center><div class='f'><font color='white'>Le mois de <font style='color:blue'>$mi2</font> jour <font style='color:blue'>$mi</font> le nom <font style='color:blue'>$mi3</font> est <font style='color:blue'>$mi4</font></div></center>";}}}}
