...
$pp2=mysql_fetch_array($result);
	...
	echo"<form action='moden.php' method='POST' name='fm'>"; 	
echo"<center><h2>Modification par nom</h2></center>";
echo"<br><br><br>";
echo "<table  >";
echo"<tr>";
...
echo "<input type='text' name='nom' style='display:none;'  value='".$pp2['nom']."'>";
	echo"</tr>";
