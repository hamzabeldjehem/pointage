...
if(isset($_POST['s'],$_POST['nom'])){
$moi=$_POST['s'];
$nom=$_POST['nom'];
$kkk=mysql_query("SELECT * FROM point   WHERE mois='$moi' and nom='$nom'  ");
...
$result=mysql_query("SELECT * FROM point   WHERE mois='$moi' and nom='$nom'  ");
if($id!=''){
echo"<center>";	
echo"<h3>$moi pour : $nom</h3>";
//echo"<h4>";	
echo "<table id='example' class='table table-striped table-bordered' >";
echo"<thead>";
echo"<tr>";
echo "<th bgcolor=#999>Jour</th>";
...
echo"<tr>";
echo "<td align=center width=30%>$pp2[jour]</td>";
...
echo "<td align=center width=30%><a href='mm.php?id=".$pp2['id']."'>Modifier</a></td>";
echo"</tr>";	
}}
